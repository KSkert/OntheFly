    ...
    *feature pack* to the session. The SESSION's single AutoForkEngine consumes
    ...
    def _compute_margins_and_embeddings(
            ...
            *,
            ...
            from .session import SeamlessSession
            ...
            with torch.no_grad():
                for batch in loader:
                    ...
                    if need_embed and SeamlessSession._embedding_hook_fn is not None:
                        try:
                            e = SeamlessSession._embedding_hook_fn_static(model, x, logits)
