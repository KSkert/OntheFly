// vscode-seamless/src/webview/dag_layout.js
(function (global) {
  ...
  function layoutDAG(nodes, edges, opts = {}) {
    ...
    // ---------- primary parent (used only for y layout) ----------
  ...
  global.enablePanZoom = enablePanZoom; // <-- expose the helper
})(window || globalThis);
